#pragma checksum "C:\Users\Michael M. Simon\Documents\HIØF\endaDesk\DeskPower\DeskPowerApp\Views\Busy.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "83AB2234671730D1E1D592EF1DA3B8F8"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace DeskPowerApp.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class Busy_obj1_Bindings :
            ...
            IBusy_Bindings
        {
            private global::DeskPowerApp.Views.Busy dataRoot;
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                ...
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::DeskPowerApp.Views.Busy)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::DeskPowerApp.Views.Busy obj, int phase)
            {
            ...
            private class Busy_obj1_BindingsTracking
            {
                ...
                public void DependencyPropertyChanged_IsBusy(global::Windows.UI.Xaml.DependencyObject sender, global::Windows.UI.Xaml.DependencyProperty prop)
                {
                    ...
                    {
                        global::DeskPowerApp.Views.Busy obj = sender as global::DeskPowerApp.Views.Busy;
                        if (obj != null)
                        {
                ...
                public void UpdateChildListeners_(global::DeskPowerApp.Views.Busy obj)
                {
                    Busy_obj1_Bindings bindings;
                    if (WeakRefToBindingObj.TryGetTarget(out bindings))
                    {
                        ...
                        {
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::DeskPowerApp.Views.Busy.IsBusyProperty, tokenDPC_IsBusy);
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::DeskPowerApp.Views.Busy.BusyTextProperty, tokenDPC_BusyText);
                        }
                        if (obj != null)
                        {
                            bindings.dataRoot = obj;
                            tokenDPC_IsBusy = obj.RegisterPropertyChangedCallback(global::DeskPowerApp.Views.Busy.IsBusyProperty, DependencyPropertyChanged_IsBusy);
                            tokenDPC_BusyText = obj.RegisterPropertyChangedCallback(global::DeskPowerApp.Views.Busy.BusyTextProperty, DependencyPropertyChanged_BusyText);
                        }
                    }
                }
            }
